...
export default function Advantages() {
  return (
    <>
      <section className="relative flex justify-center items-center w-full my-20">
        <div className="w-[30%] flex flex-col justify-center">
          <span className="leading-relaxed font-light capitalize text-sm text-[#FF5555]">
            ADVANTAGES
          </span>
          <span className="capitalize text-5xl font-extrabold leading-tight">
            Why Choose Uifry?
          </span>
          <div className="flex flex-col justify-center my-5 w-full space-y-5">
            <p className="flex flex-col space-y-3 text-xl">
        ...
        <div className="w-[40%] relative">
          ...
          <Image src={advantagecard} alt="advantages card" className="absolute bottom-52 right-20 w-[40%]"/>
        </div>
        <Image
          src={star}
          alt="star"
      ...
      <section className="relative flex justify-evenly items-center w-[80%]">
      <div className="w-[50%] relative">
          <Image src={customizable} alt="customizable"/>
          <Image src={customizablecard} alt="advantages card" className="absolute top-36 left-44 w-[35%]"/>
        </div>
        <div className="w-[45%] flex flex-col justify-center">
          <div className="flex flex-col justify-center my-5 w-full space-y-5">
            <p className="flex flex-col space-y-3">
              <span className="font-bold flex items-center leading-tight text-xl">
                <svg
                  width="48"
                  height="49"
                  viewBox="0 0 48 49"
