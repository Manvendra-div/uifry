...
export default function Features() {
  return (
    <section className="relative flex justify-between items-center w-full mt-20">
      <div className="w-[40%]">
      ...
      <div className="w-[60%] flex flex-col justify-center">
        ...
        <span className="capitalize font-extrabold text-3xl leading-tight">
          Uifry premium
        </span>
        <div className="flex flex-col justify-center my-5 w-[70%] space-y-5">
      ...
      <Image src={texture} alt="texture" className="absolute -z-10 -right-10" />
      <Image src={star} alt="star" width={30} className="absolute -z-10 top-10 left-4" />
    </section>
  );
}
